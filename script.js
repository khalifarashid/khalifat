...
(function () {
  ...
  var WHATSAPP_LINK =
    "https://wa.me/971547771747?text=" + encodeURIComponent("Hi Craftbyte, I'd like to talk about a website.");
  var CONTACT_HTML =
  ...
  var knowledge = [
    ...
    },
    {
      ...
      answer: "Hey! I'm the Craftbyte site assistant — ask me about pricing, timelines, or what's included in each package."
    },
    {
  ...
  function openChat() {
    ...
    if (!greeted) {
      greeted = true;
      addMessage(
        "Hi, I'm the Craftbyte assistant. Ask me anything about building a website — pricing, timelines, what's included — " +
